...
if ($titol === '') {
    header('Location: ../view/insertar.vista.php?error=' . urlencode('El titulo es obligatorio'));
    exit;
}
...
if ($ok) {
    header('Location: ../view/index.php?ok=' . urlencode('Pokemon insertado'));
    exit;
}
header('Location: ../view/insertar.vista.php?error=' . urlencode('No se ha podido insertar'));
exit;
